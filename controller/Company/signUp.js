...
const signUp = async (req, res) => {
    ...
    try {
        ...
        Click on this link to complete your registration process <a href="https://xped8-ca9291a9a7e0.herokuapp.com/dashboard/${token}">Greenpeg ERP Platform</a> as an employee 
