...
const signUp = async (req, res) => {
    ...
    try {
        ...
        Click on this link to complete your registration process <a href="https://silo-hrm-15cf632a6d01.herokuapp.com/dashboard/${token}">silo ERP Platform</a> as an employee 
